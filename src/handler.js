 ...
 */
const SLUG_TO_PAGE = {
  '': 'ildarsafin/Ildar-Safin-Software-developer-d47ddbf7c63045c28f960eff17bd13e7',
};


/* Step 3: enter your page title and description for SEO purposes */
const PAGE_TITLE = 'Ildar Safin Portfolio';
const PAGE_DESCRIPTION = 'Ruby on Rails Developer';
...
async function fetchAndApply(request) {
  ...
  if (headers['content-type'].indexOf('text/html') > -1 && !request.path.startsWith("/ildarsafin")) {
...
function rewriteBody($) {
  $('body').append(
    ...
    window.CONFIG.domainBaseUrl = "https://ildarsafin.tech";
    function getPage() {
...
// starting point for Lambda script
